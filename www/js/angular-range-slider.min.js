  ...
  module.directive('rangeSlider', ['$timeout', function($timeout){
    ...
    return {
      ...
      link : function(scope, element, attrs) {
        ...
        var updateDOM = function () {
          ...
          var setPointers = function () {
            ...
            scope.lowDisplayVal = scope.local[low];
          scope.highDisplayVal = scope.local[high];
      ...
      template :  '<div class="bar"><div class="selection"></div></div>' +
                  ...
                  '<div class="bubble value low">{{ lowDisplayVal }}</div>' +
                  '<div class="bubble value high">{{ highDisplayVal }}</div>'
